...
use std::os::raw::{c_uchar, c_int, c_uint, c_char, c_void, c_ulong};
...
pub struct sc_pkcs15init_operations {
     ...
     */
    pub erase_card : Option< unsafe extern "C" fn (profile: *mut sc_profile, p15card: *mut sc_pkcs15_card) -> c_int >,
     ...
     */
    pub init_card  : Option< unsafe extern "C" fn (profile: *mut sc_profile, p15card: *mut sc_pkcs15_card) -> c_int >,

    /*
     * Create a DF
     */
    pub create_dir : Option< unsafe extern "C" fn (profile: *mut sc_profile, p15card: *mut sc_pkcs15_card,
                                                   file: *mut sc_file) -> c_int >,
    /*
    ...
    pub create_domain : Option< unsafe extern "C" fn (profile: *mut sc_profile, p15card: *mut sc_pkcs15_card,
                                                      id: *const sc_pkcs15_id, file: *mut *mut sc_file) -> c_int >,
    ...
    pub select_pin_reference : Option< unsafe extern "C" fn (profile: *mut sc_profile, p15card: *mut sc_pkcs15_card,
                                                             pin_ainfo: *mut sc_pkcs15_auth_info) -> c_int >,
    ...
    pub create_pin : Option< unsafe extern "C" fn (profile: *mut sc_profile, p15card: *mut sc_pkcs15_card,file:*mut sc_file,
                                                   object: *mut sc_pkcs15_object, arg5: *const c_uchar, arg6: usize,
                                                   arg7: *const c_uchar, arg8: usize) -> c_int >,
    ...
    pub select_key_reference : Option< unsafe extern "C" fn (profile: *mut sc_profile, p15card: *mut sc_pkcs15_card,
                                                             arg3: *mut sc_pkcs15_prkey_info) -> c_int >,
    ...
    pub create_key : Option< unsafe extern "C" fn (profile: *mut sc_profile, p15card: *mut sc_pkcs15_card,
                                                   object: *mut sc_pkcs15_object) -> c_int >,
    ...
    pub generate_key : Option< unsafe extern "C" fn (profile: *mut sc_profile, p15card: *mut sc_pkcs15_card,
                                                     object: *mut sc_pkcs15_object, arg4: *mut sc_pkcs15_pubkey) -> c_int >,
    ...
    pub encode_private_key : Option< unsafe extern "C" fn (profile: *mut sc_profile, arg2: *mut sc_card,
                                                           arg3: *mut sc_pkcs15_prkey_rsa, arg4: *mut c_uchar,
                                                           arg5: *mut usize, arg6: c_int) -> c_int >,
     ...
     * cards).
     */
    pub finalize_card : Option< unsafe extern "C" fn (card: *mut sc_card) ->  c_int >,

    /*
     * Delete object
     */
    pub delete_object : Option< unsafe extern "C" fn (profile: *mut sc_profile, p15card: *mut sc_pkcs15_card,
                                                      object: *mut sc_pkcs15_object, path: *const sc_path) -> c_int >,
    ...
    pub emu_store_data : Option< unsafe extern "C" fn (p15card: *mut sc_pkcs15_card, profile: *mut sc_profile,
                                                       ...
                                                       path: *mut sc_path) -> c_int >,

    pub sanity_check : Option< unsafe extern "C" fn (profile: *mut sc_profile, p15card: *mut sc_pkcs15_card) -> c_int >,
}
...
pub struct sc_pkcs15init_callbacks {
     ...
     */
    pub get_pin : Option < unsafe extern "C" fn (arg1: *mut sc_profile, arg2: c_int, arg3: *const sc_pkcs15_auth_info,
                                                 arg4: *const c_char, arg5: *mut c_uchar, arg6: *mut usize) -> c_int >,

    /*
     * Get a transport/secure messaging key from the front-end.
     */
    pub get_key : Option < unsafe extern "C" fn (arg1: *mut sc_profile, arg2: c_int, arg3: c_int, arg4: *const c_uchar,
                                                 arg5: usize, arg6: *mut c_uchar, arg7: *mut usize) -> c_int >,
}
...
pub struct sc_pkcs15init_keyarg_gost_params {
    pub gostr3410 : c_uchar,
    pub gostr3411 : c_uchar,
    pub gost28147 : c_uchar,
}
...
pub struct sc_pkcs15init_skeyargs {
    ...
    #[cfg(not(any(v0_17_0, v0_18_0, v0_19_0)))]
    pub session_object : c_int, /* If nonzero. this is a session object, which will
...
extern "C" {
fn sc_pkcs15init_new_object(arg1: c_int, arg2: *const c_char, arg3: *mut sc_pkcs15_id, arg4: *mut c_void)
...
pub fn sc_pkcs15init_bind(arg1: *mut sc_card, arg2: *const c_char, arg3: *const c_char, app_info: *mut sc_app_info, arg4: *mut *mut sc_profile) -> c_int;
...
pub fn sc_pkcs15init_set_lifecycle(arg1: *mut sc_card, arg2: c_int) -> c_int;

pub fn sc_pkcs15init_erase_card(arg1: *mut sc_pkcs15_card, arg2: *mut sc_profile, arg3: *mut sc_aid) -> c_int;

/* XXX could this function be merged with ..._set_lifecycle ?? */
pub fn sc_pkcs15init_finalize_card(arg1: *mut sc_card, arg2: *mut sc_profile) -> c_int;

pub fn sc_pkcs15init_add_app(arg1: *mut sc_card, arg2: *mut sc_profile, arg3: *mut sc_pkcs15init_initargs) -> c_int;

pub fn sc_pkcs15init_store_pin(arg1: *mut sc_pkcs15_card, arg2: *mut sc_profile, arg3: *mut sc_pkcs15init_pinargs) -> c_int;

pub fn sc_pkcs15init_generate_key(arg1: *mut sc_pkcs15_card, arg2: *mut sc_profile, arg3: *mut sc_pkcs15init_keygen_args, keybits: c_uint, arg4: *mut *mut sc_pkcs15_object) -> c_int;

pub fn sc_pkcs15init_generate_secret_key(arg1: *mut sc_pkcs15_card, arg2: *mut sc_profile,
                                         arg3: *mut sc_pkcs15init_skeyargs, arg4: *mut *mut sc_pkcs15_object) -> c_int;

pub fn sc_pkcs15init_store_private_key(arg1: *mut sc_pkcs15_card, arg2: *mut sc_profile, arg3: *mut sc_pkcs15init_prkeyargs, arg4: *mut *mut sc_pkcs15_object) -> c_int;
/*
extern int    sc_pkcs15init_store_split_key(struct sc_pkcs15_card *,
                ...
                struct sc_pkcs15_object **);
*/
pub fn sc_pkcs15init_store_public_key(arg1: *mut sc_pkcs15_card, arg2: *mut sc_profile, arg3: *mut sc_pkcs15init_pubkeyargs, arg4: *mut *mut sc_pkcs15_object) -> c_int;

    pub fn sc_pkcs15init_store_secret_key(arg1: *mut sc_pkcs15_card, arg2: *mut sc_profile, arg3: *mut sc_pkcs15init_skeyargs, arg4: *mut *mut sc_pkcs15_object) -> c_int;

pub fn sc_pkcs15init_store_certificate(arg1: *mut sc_pkcs15_card, arg2: *mut sc_profile, arg3: *mut sc_pkcs15init_certargs, arg4: *mut *mut sc_pkcs15_object) -> c_int;

pub fn sc_pkcs15init_store_data_object(arg1: *mut sc_pkcs15_card , arg2: *mut sc_profile , arg3: *mut sc_pkcs15init_dataargs, arg4: *mut *mut sc_pkcs15_object) -> c_int;
 ...
 */
pub fn sc_pkcs15init_change_attrib(arg1: *mut sc_pkcs15_card, arg2: *mut sc_profile, arg3: *mut sc_pkcs15_object, arg4: c_int, arg5: *mut c_void, arg6: c_int) -> c_int;

fn sc_pkcs15init_add_object(p15card: *mut sc_pkcs15_card, profile: *mut sc_profile, arg2: c_uint, arg3: *mut sc_pkcs15_object) -> c_int;

pub fn sc_pkcs15init_delete_object(arg1: *mut sc_pkcs15_card, arg2: *mut sc_profile, arg3: *mut sc_pkcs15_object) -> c_int;
 ...
 */
pub fn sc_pkcs15init_update_certificate(arg1: *mut sc_pkcs15_card, arg2: *mut sc_profile, arg3: *mut sc_pkcs15_object, arg4: *const c_uchar, arg5: usize) -> c_int;

pub fn sc_pkcs15init_create_file(arg1: *mut sc_profile, arg2: *mut sc_pkcs15_card, arg3: *mut sc_file) -> c_int;

pub fn sc_pkcs15init_update_file(arg1: *mut sc_profile, arg2: *mut sc_pkcs15_card, arg3: *mut sc_file, arg4: *mut c_void, arg5: c_uint) -> c_int;

pub fn sc_pkcs15init_authenticate(profile: *mut sc_profile, p15card: *mut sc_pkcs15_card, file: *mut sc_file, op: c_int) -> c_int;

pub fn sc_pkcs15init_fixup_file(arg1: *mut sc_profile, arg2: *mut sc_pkcs15_card, arg3: *mut sc_file) -> c_int;

pub fn sc_pkcs15init_get_pin_info(arg1: *mut sc_profile, arg2: c_int, arg3: *mut sc_pkcs15_auth_info) -> c_int;
/*
extern int    sc_profile_get_pin_retries(struct sc_profile *, int);
*/
pub fn sc_pkcs15init_get_manufacturer(arg1: *mut sc_profile, arg2: *mut *const c_char) -> c_int;

pub fn sc_pkcs15init_get_serial(arg1: *mut sc_profile, arg2: *mut *const c_char) -> c_int;

pub fn sc_pkcs15init_set_serial(arg1: *mut sc_profile, arg2: *const c_char) -> c_int;

pub fn sc_pkcs15init_verify_secret(arg1: *mut sc_profile, arg2: *mut sc_pkcs15_card, arg3: *mut sc_file, arg4: c_uint, arg5: c_int) -> c_int;

pub fn sc_pkcs15init_delete_by_path(arg1: *mut sc_profile, arg2: *mut sc_pkcs15_card, arg3: *const sc_path) -> c_int;

pub fn sc_pkcs15init_update_any_df(arg1: *mut sc_pkcs15_card, arg2: *mut sc_profile, arg3: *mut sc_pkcs15_df, arg4: c_int) -> c_int;
/*
...
pub fn sc_pkcs15init_erase_card_recursively(arg1: *mut sc_pkcs15_card, arg2: *mut sc_profile) -> c_int;

pub fn sc_pkcs15init_rmdir(p15card: *mut sc_pkcs15_card, profile: *mut sc_profile, arg3: *mut sc_file) -> c_int;
/*
...
*/
pub fn sc_pkcs15init_sanity_check(arg1: *mut sc_pkcs15_card, arg2: *mut sc_profile) -> c_int;

pub fn sc_pkcs15init_finalize_profile(card: *mut sc_card, profile: *mut sc_profile, aid: *mut sc_aid) -> c_int;
/*

...
//        println!("cargo:rustc-link-search=native=/usr/lib64"); // specifies where libiup.so is located
//        println!("cargo:rustc-link-search=native=C:/bin"); // specifies where libiup.dylib/ iup.lib is located
    }
